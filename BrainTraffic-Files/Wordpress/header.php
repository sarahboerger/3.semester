...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><!--bruger ikon start--><i class="fas fa-bars"></i><!--bruger ikon slut--><?php esc_html_e( '', 'braintraffic' ); ?></button>
			<?php
			wp_nav_menu(
				array(
